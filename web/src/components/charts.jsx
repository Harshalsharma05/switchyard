// Overview's two charts. Both take the series shape /admin/summary returns and
// apply the shared Recharts overrides from chartColors.js.
import {
  Bar, BarChart, CartesianGrid, Line, LineChart, ResponsiveContainer, Tooltip, XAxis, YAxis,
} from 'recharts'
import { AXIS_PROPS, CHART_MARGIN, CURSOR_PROPS, GRID_PROPS, OVERHEAD_SERIES } from './chartColors.js'
import ChartTooltip from './ChartTooltip.jsx'
import { EmptyState } from './states.jsx'
import { formatAxisTime, formatCount, formatMs } from '../utils/format.js'
